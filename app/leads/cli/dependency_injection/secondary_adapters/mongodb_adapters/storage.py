...
from leads.application_core.secondary_ports.forests import ForestPersister, ForestRetriever
...
from leads.secondary_adapters.mongodb_adapter.storage import persist_forest, retrieve_forests
...
def register_dependencies(container: Container) -> None:
    ...
    container.register_singleton(persist_forest, key=ForestPersister)
    container.register_singleton(retrieve_forests, key=ForestRetriever)
    return None
