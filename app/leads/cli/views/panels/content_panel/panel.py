...
class ContentPanel(Container):
    ...
    def __init__(self,
        ...
        self.configuration_view_model = configuration_view_model
        self.hotkeys_view_model = hotkeys_view_model
        self.notification_view_model = notification_view_model
    ...
    def compose(self) -> ComposeResult:
        cfg = ConfigurationTab(self.configuration_view_model, self.hotkeys_view_model)
